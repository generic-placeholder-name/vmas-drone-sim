...
def test_ant_move_to(ant1, waypoint1, waypoint2, waypoint3, waypoint4, edge_w1_w2, edge_w3_w2, edge_w3_w4):
    ...
    assert ant1.distance_traveled == 0
    assert ant1.radians_rotated == 0
    ...
    assert ant1.distance_traveled == edge_w1_w2.length
    assert ant1.radians_rotated == 0
    ...
    assert ant1.distance_traveled == edge_w1_w2.length + edge_w3_w2.length
    assert ant1.radians_rotated == abs(Elbow(edge_w1_w2, edge_w3_w2).angle())
